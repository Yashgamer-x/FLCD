...
public class LeftWidthChildComputeInjector implements ComputeInjectable {
    ...
    public void inject(AbstractNode abstractNode) {
        ...
        if ((!(precomputable instanceof LeftWidthChildCompute || precomputable instanceof FirstChildRootifiedCompute))) {
            abstractNode.setComputable(new LeftWidthChildCompute());
        }
    }
}
