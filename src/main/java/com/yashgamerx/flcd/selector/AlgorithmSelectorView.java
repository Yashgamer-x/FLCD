package com.yashgamerx.flcd.selector;

import com.yashgamerx.flcd.cmel.algorithm.CircleMaximumEdgeLengthAlgorithm;
import com.yashgamerx.flcd.cmel.file.CircleMaximumEdgeLengthFileParsingService;
import com.yashgamerx.flcd.cmel.view.CircleMaximumEdgeLengthVisualizationView;
import com.yashgamerx.flcd.flcd.algorithm.PlanarGridAlgorithm;
...
public class AlgorithmSelectorView extends BorderPane {
    ...
    @FXML
    private Button processAlgorithmButton;
    @FXML
    ...
    /// but transitions to [TMELTreeVisualizationView] instead —
    ...
    private void runFlcdMaximumEdgeLengthPipeline() {
        ...
        parsingResult.ifPresentOrElse(map -> {
            ...
            var currentScene = this.getScene();
            currentScene.setRoot(visualizationView);
            log.info("Transitioned to TMELTreeVisualizationView.");
        }, () -> log.warning("Parsing failed; transition aborted."));
    }
